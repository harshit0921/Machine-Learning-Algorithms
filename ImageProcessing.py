...
directory = 'D:/git/Machine-Learning-Algorithms/HAM10000_images/' + data['Name'][0] + '.jpg'
...
images = torch.zeros(int(len(data['Name'])/batches), pixels)

#For each batch
for j in range(batches):
    #For each image in a batch
    for i in range(int(len(data['Name'])/batches)):
        directory = 'D:/git/Machine-Learning-Algorithms/HAM10000_images/' + data['Name'][batches*j + i] + '.jpg'
        im = Image.open(directory, 'r')
